<table width="80%" height="40" cellspacing="0" cellpadding="10" border="1" align="center">
    ...
    <tr>
	    ...
	    <form method="post">
			...
			<h2><i>List with <u>Top customer</u> according to cost spent: </i></h2><br>
	        ...
	        <table width="90%" height="90%" border="1" cellspacing="0" cellpadding="7" valign="top">
				...
				@foreach($topuserlist as $topUser)  
				<tr>
					<td align="center"> {{$topUser->orderId}} </td>
					<td align="center"><i> {{$topUser->customerName}} </i></td>
					<td align="center"> {{$topUser->orderCost}} </td>
				</tr>
				@endforeach
			</table><br><br>
